...
public class TrimmingFastqONTModule extends AbstractModule {
    ...
    public TaskResult execute(TaskContext context, TaskStatus status) {
        ...
        try {
            ...
            final Data adaptorData = context.getInputData(DataFormatRegistry.getInstance().getDataFormatFromName("cutadapt_adapter"));
            ...
            try {
                ...
                if (this.palindromeClipThresholdTrimmomatic != 0) {
                    trim.setPalindromeClipThresholdTrimmomatic(this.palindromeClipThresholdTrimmomatic);
                }
