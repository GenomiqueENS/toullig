...
public class Fast5Test {
	...
	//
     ...
     Fast5 testf7 = new Fast5(getResourceAsFile(file7));
     String sequence7=readInputStream("/dnacpc14_20170124_R9-4_2D_template.fastq");
     ...
     Fast5 testf7 = new Fast5(getResourceAsFile(file7));
     String sequence7=readInputStream("/dnacpc14_20170124_R9-4_2D_complement.fastq");
     ...
     Fast5 testf1 = new Fast5(getResourceAsFile(file1));
     assertEquals("Previous basecall was not successful -- returning failure", testf1.getCalibrationStrandFinalStatus());
     testf1.close();
